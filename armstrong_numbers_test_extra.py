...
class ArmstrongNumbersTest(unittest.TestCase):
    def test_empty_is_an_armstrong_number(self):
        self.assertIs(is_armstrong_number(''), False)

    def test_space_is_an_armstrong_number(self):
        self.assertIs(is_armstrong_number(' '), False)

    def test_non_numeric_is_an_armstrong_number(self):
        self.assertIs(is_armstrong_number('a'), False)

    def test_negative_number_is_an_armstrong_number(self):
        self.assertIs(is_armstrong_number(-2), False)
